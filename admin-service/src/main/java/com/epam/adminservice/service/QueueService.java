...
public class QueueService {
    ...
    public void addProductToQueue(String type, CreateGoodDto productDto) {
        logger.info("Add good Entity with id {} to queue. Operation type is {}", productDto.getId(), type);
    ...
    public void addImageToQueue(String type, GetImageDto imageDto) {
        logger.info("Add image Entity with id {} to queue. Operation type is {}", imageDto.getImageId(), type);
